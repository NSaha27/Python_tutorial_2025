...
if len(stu_name) == 0:
    ...
    stu_name = input("Enter a valid name: ")

stu_gender = input("Enter a gender (M/F/O): ")
if len(stu_gender) == 0:
    print("gender must be given!")
    stu_gender = input("Enter a valid gender (M/F/O): ")

if stu_gender == "m" or stu_gender == "M":
    stu_gender = "Male"
elif stu_gender == "f" or stu_gender == "F":
    stu_gender = "Female"
elif stu_gender == "o" or stu_gender == "O":
    stu_gender = "Other"
else:
    print("invalid input!")
    stu_gender = input("Enter a valid gender (M/F/O): ")
...
print(f"Student gender: {stu_gender}")
print("Marksheet:")
